            ...
            <div class="row mb-5">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->sertifikatTanah)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->penetapanTataRuang)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->penyelesaianSengketa)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->salinanPerjanjian)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            @if (isset($ispo->stdb))
                            <a href="{{url('storage/ispo/' . $ispo->stdb)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->suratIzinLingkungan)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->catatanPelaksanaan)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->suratMemilikiKelambagaan)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->suratKelompokTani)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->sertifikat)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->laporanKegiatanPerkebun)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            @if (isset($ispo->sop))
                            <a href="{{url('storage/ispo/' . $ispo->sop)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->dokumenRencanaKegiatan)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->catatanAsalBenih)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->sopPenanaman)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->catatanPelaksanaanPenanaman)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->catatanPenanaman)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->sopPemeliharaanTanaman)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->catatanPemupukanTanaman)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            @if (isset($ispo->ipm))
                            <a href="{{url('storage/ispo/' . $ispo->ipm)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->suratPengendalianOPT)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->acuanTeknisPanen)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->catatanPelaksanaanPemanenan)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->petunjukTeknis)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->pencegahanPenanggulanganKebakaran)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->keberadaanSatwaTumbuhan)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->keberadaanSatwaTumbuhanKebun)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->informasiHargaTBS)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->catatanHargaTBSRealisasiPembelian)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->sopPelayanan)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->pemberianInformasiKepadaPemangkuKepentingan)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->tanggapanPermintaanInformasiDariPemangkuKepentingan)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <a href="{{url('storage/ispo/' . $ispo->perbaikanUsaha)}}" target="_blank">View Uploaded File <i class="fa fa-file"></i></a>
                            @endif
